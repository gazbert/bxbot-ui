 ...
 * @author gazbert
 */
var ExchangeAdapterHttpDataObservableService = ExchangeAdapterHttpDataObservableService_1 = (function () {
    function ExchangeAdapterHttpDataObservableService(http) {
        this.http = http;
        this.exchangeAdaptersUrl = app_component_1.AppComponent.REST_API_BASE_URL + '/exchange_adapters';
    }
    ExchangeAdapterHttpDataObservableService.prototype.getExchangeAdapters = function () {
        ...
        return this.http.get(this.exchangeAdaptersUrl, { headers: headers })
            .map(ExchangeAdapterHttpDataObservableService_1.extractData)
            .catch(ExchangeAdapterHttpDataObservableService_1.handleError);
    };
    ExchangeAdapterHttpDataObservableService.prototype.getExchangeAdapterByBotId = function (botId) {
        var headers = new http_1.Headers({
            'Content-Type': 'application/json',
            'Authorization': 'Bearer ' + authentication_service_1.AuthenticationService.getToken()
        });
    ...
    ExchangeAdapterHttpDataObservableService.prototype.update = function (exchangeAdapter) {
        var headers = new http_1.Headers({
            'Content-Type': 'application/json',
            'Authorization': 'Bearer ' + authentication_service_1.AuthenticationService.getToken()
        });
        var url = this.exchangeAdaptersUrl + '/' + exchangeAdapter.id;
        var body = JSON.stringify(exchangeAdapter);
        var options = new http_1.RequestOptions({ headers: headers });
        return this.http.put(url, body, options)
            .map(ExchangeAdapterHttpDataObservableService_1.extractData)
            .catch(ExchangeAdapterHttpDataObservableService_1.handleError);
    };
    ExchangeAdapterHttpDataObservableService.handleError = function (error) {
    ...
    ExchangeAdapterHttpDataObservableService.extractData = function (res) {
    ...
    return ExchangeAdapterHttpDataObservableService;
}());
ExchangeAdapterHttpDataObservableService = ExchangeAdapterHttpDataObservableService_1 = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http])
], ExchangeAdapterHttpDataObservableService);
exports.ExchangeAdapterHttpDataObservableService = ExchangeAdapterHttpDataObservableService;
var ExchangeAdapterHttpDataObservableService_1;
//# sourceMappingURL=exchange-adapter-http-data-observable.service.js.map