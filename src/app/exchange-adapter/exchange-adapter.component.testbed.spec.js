...
var fixture;
var page;
describe('ExchangeAdapterComponent tests using TestBed', function () {
    beforeEach(function () {
...
function overrideExchangeAdapterServiceSetup() {
    ...
    var StubExchangeAdapterHttpDataService = (function () {
        ...
        StubExchangeAdapterHttpDataService.prototype.getExchangeAdapterByBotId = function (id) {
            return Promise.resolve(true).then(function () { return Object.assign({}, testExchangeAdapter); });
        };
        StubExchangeAdapterHttpDataService.prototype.update = function (exchangeAdapter) {
            return Promise.resolve(true).then(function () { return Object.assign(testExchangeAdapter, exchangeAdapter); });
        };
    ...
    beforeEach(testing_1.async(function () {
        testing_1.TestBed.configureTestingModule({
            imports: [exchange_adapter_module_1.ExchangeAdapterModule, forms_1.FormsModule, shared_module_1.SharedModule],
            providers: [
                ...
                { provide: promise_1.ExchangeAdapterHttpDataPromiseService, useValue: {} }
            ]
        })
            .overrideComponent(exchange_adapter_component_1.ExchangeAdapterComponent, {
            set: {
                providers: [
                    { provide: promise_1.ExchangeAdapterHttpDataPromiseService, useClass: StubExchangeAdapterHttpDataService }
                ]
            }
        })
    ...
    beforeEach(testing_1.async(function () {
        ...
        stubExchangeAdapterDataService = fixture.debugElement.injector.get(promise_1.ExchangeAdapterHttpDataPromiseService);
    }));
    xit('should inject the stubbed Exchange Adapter service', testing_1.inject([promise_1.ExchangeAdapterHttpDataPromiseService], function (service) {
    ...
    it('should create new Error Message when user adds one', function () {
    ...
    it('should remove Error Message when user deletes one', function () {
        expect(testExchangeAdapter.networkConfig.nonFatalErrorMessages.length).toBe(1);
 ...
 */
var BITSTAMP = 0;
var firstExchangeAdapter = testing_3.SOME_FAKE_PROMISE_EXCHANGE_ADAPTERS[BITSTAMP];
function fakeExchangeAdapterServiceSetup() {
    beforeEach(testing_1.async(function () {
        testing_1.TestBed.configureTestingModule({
            ...
            providers: [
                { provide: testing_2.ActivatedRoute, useValue: activatedRoute },
                { provide: promise_1.ExchangeAdapterHttpDataPromiseService, useClass: testing_3.FakeExchangeAdapterDataPromiseService },
                { provide: testing_2.Router, useClass: testing_2.RouterStub },
...
function createComponent() {
    fixture = testing_1.TestBed.createComponent(exchange_adapter_component_1.ExchangeAdapterComponent);
...
var Page = (function () {
    function Page() {
        ...
        var exchangeAdapterDataService = compInjector.get(promise_1.ExchangeAdapterHttpDataPromiseService);
...
//# sourceMappingURL=exchange-adapter.component.testbed.spec.js.map